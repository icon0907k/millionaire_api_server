...
import afterwork.millionaire.api.domestic.tradingaccount.service.DsBuyableAmountService;
...
public class DsBuyableAmountController {

    private final DsBuyableAmountService dsBuyableAmountService;
    ...
    public Mono<ResponseEntity<Map<String, Object>>> getOverseasStockBuyableAmount(
            @ModelAttribute DsBuyableAmountRequest request,
            @RequestHeader HttpHeaders headers
    ) {
        // 서비스 계층을 호출하여 매수 가능 금액 데이터를 조회하고 결과를 반환합니다.
        return dsBuyableAmountService.getDomesticStockBuyableAmount(request, headers);
    }
}
