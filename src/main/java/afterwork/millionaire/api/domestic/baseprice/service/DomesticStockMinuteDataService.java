...
/**
 * DomesticStockMinuteDataService
 * 국내 주식 분봉 데이터를 처리하는 서비스 클래스입니다.
 * 데이터 요청 및 두 시점 간의 비교 기능을 제공합니다.
 */
@Service
public class DomesticStockMinuteDataService {
     ...
     * @return 주식 분봉 데이터 응답
     */
    public Mono<ResponseEntity<Map<String, Object>>> getDomesticStockMinuteData(DomesticStockMinuteDataRequest request, HttpHeaders headers) {
    ...
    public Mono<ResponseEntity<Map<String, Object>>> getDomesticStockTimeRangeQuery(
            DomesticStockMinuteDataRequest request1,
            DomesticStockMinuteDataRequest request2,
            HttpHeaders headers,
            String time1,
            String time2) {
