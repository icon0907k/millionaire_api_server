...
import afterwork.millionaire.api.domestic.baseprice.service.DsPriceService;
...
public class DsPriceController {

    private final DsPriceService dSpriceService;
    ...
    public Mono<ResponseEntity<Map<String, Object>>> getDomesticStockPrice(
            @ModelAttribute DsPriceRequest request,
            @RequestHeader HttpHeaders headers
    ) {
        // 서비스 계층에서 요청 데이터를 처리하고 결과 반환
        return dSpriceService.getDomesticStockPrice(request, headers);
    }
}
