...
/**
 * OsPriceService
 * 해외 주식 가격 데이터를 처리하는 서비스 클래스입니다.
 * 주식 가격 데이터를 요청하는 기능을 제공합니다.
 */
@Service
@RequiredArgsConstructor
public class OsPriceService {

    private final ApiProperties apiProperties;

    /**
     * 해외 주식 가격 데이터를 요청하는 메소드입니다.
     * @param request 요청에 필요한 파라미터를 포함하는 DTO
     * @param headers HTTP 요청 헤더
     * @return API 응답 결과를 포함하는 Mono 객체
     */
    public Mono<ResponseEntity<Map<String, Object>>> getOverseasStockPrice(OsPriceRequest request, HttpHeaders headers) {
